<section id="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <h4 class="white">Email Updates</h4>
                <p class="fontfooter">Be the first to hear about our offers and announcement</p>
                <p>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group has-feedback">
                                <input type="text" class="form-control subscriber" placeholder="subscriber@email.com">
                                <span class="glyphicon glyphicon-envelope form-control-feedback" aria-hidden="true" style="color:#00A50E"></span>
                            </div>
                        </div>
                    </div>
                </p>
            ...
            <div class="col-md-4">
                ...
                <p class="fontfooter">Ready to start your next project with us? That's great! Give us a call or send us an email and we will get back to you as soon as possible!</p>
                <p>
                    <div class="row">
